...
import { DBProblem, Problem } from "../../../utils/types/problem.ts";
...
const ProblemDescription = ({ problem, _solved, submVideo }) => {
	...
	return (
		<div className='bg-dark-layer-1'>
			{/* TAB */}
			<div className='flex h-11 items-center pt-2 bg-dark-layer-2 text-white overflow-x-hidden'>
				<div className={"bg-dark-layer-1 rounded-t-[5px] px-5 py-[10px] text-xs cursor-pointer"}>
					Description
				</div>
			</div>
			{/* <div className="relative w-24 h-24 float-right">
				<div><WebcamVideo submVideo={submVideo}/></div>	
			</div> */}
